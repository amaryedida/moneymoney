    ...
    private fun exportInvestmentListAsCSV() {
        try {
            ...
            for (investment in filteredInvestments) {
                writer.write("${investment.id.toString()},${investment.currency},${investment.category},\"${investment.value}\",${investment.comment ?: ""},${investment.date},${investment.goalId ?: ""},${investment.goalName ?: ""}\n")
            }
            writer.close()
